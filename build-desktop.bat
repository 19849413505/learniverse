...
echo =======================================================
echo          Learniverse One-Click Installer
echo          Learniverse 一键安装与桌面端打包工具
echo =======================================================
echo.
echo Checking and installing all necessary dependencies...
echo 正在检查和安装所有必要的依赖...
...
echo.
echo =======================================================
echo Dependencies installed! Building desktop app...
echo 依赖安装完成！开始构建代码并打包桌面应用...
echo =======================================================
echo.
...
if %ERRORLEVEL% neq 0 (
    echo.
    color 0C
    echo [ERROR] Packaging failed. Please scroll up to see logs.
